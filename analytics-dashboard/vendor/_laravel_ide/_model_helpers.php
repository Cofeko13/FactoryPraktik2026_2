...
namespace App\Models {
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric whereId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric whereSourceId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric whereDate($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric whereVisits($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric whereCreatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric whereUpdatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric newModelQuery()
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric newQuery()
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric query()
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric forPeriod(int $days) {@see App\Models\Metric::scopeForPeriod()}
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric forSource(?int $sourceId) {@see App\Models\Metric::scopeForSource()}
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric filtered(int $period, ?int $sourceId) {@see App\Models\Metric::scopeFiltered()}
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<Metric>|Metric timeout(int $seconds)
   ...
   */
  class Metric extends \Illuminate\Database\Eloquent\Model
  {
    //
  }
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<Source>|Source whereSlug($value)
   ...
   * @method static mixed lockForUpdate()
   * @method static mixed sharedLock()
   * @method static \Illuminate\Database\Eloquent\Builder<Source>|Source timeout(int $seconds)
   * @method static mixed beforeQuery(callable $callback)
   * @method static mixed applyBeforeQueryCallbacks()
   * @method static mixed afterQuery(Closure $callback)
   * @method static mixed applyAfterQueryCallbacks($result)
